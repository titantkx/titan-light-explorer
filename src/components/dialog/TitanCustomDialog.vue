  ...
  <div class="text-gray-600">
    ...
    <label :for="type" class="modal cursor-pointer">
      <label
        ...
        :class="{ '!w-11/12 !max-w-5xl': String(type).startsWith('wasm') }"
        for=""
      >
        <label :for="type" class="btn btn-sm btn-circle absolute right-4 top-4"
          >✕</label
        >
