...
let rate = computed(() =>
  BigNumber(props.commission?.commission_rates.rate || 0)
    .times(100)
    .toNumber()
);
let change = computed(() =>
  BigNumber(props.commission?.commission_rates.max_change_rate || 0)
    .times(100)
    .toNumber()
);
let max = computed(() =>
  BigNumber(props.commission?.commission_rates.max_rate || 1)
    .times(100)
    .toNumber()
);
